<?php
    ...
    $sql="UPDATE reservationprojecteur set IsRead=:isread where id=:did";
    ...
    $sql="UPDATE reservationprojecteur set Status=:status,AdminRemarkDate=:admremarkdate where id=:did";
    $query = $dbh->prepare($sql);
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Reservation Details</h4>
                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            $sql = "SELECT reservationprojecteur.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,reservationprojecteur.NomMatiere,reservationprojecteur.ToDate,reservationprojecteur.FromDate,reservationprojecteur.PostingDate,reservationprojecteur.Status,reservationprojecteur.AdminRemarkDate,reservationprojecteur.NomClasse from reservationprojecteur join tblemployees on reservationprojecteur.empid=tblemployees.id where reservationprojecteur.id=:lid";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            <td colspan="1"><?php echo htmlentities($result->EmailId);?></td>
                                             ...
                                             <tr>
                                     <td ><b>Envoyée</b></td>
                                <td colspan="3"><?php echo htmlentities($result->PostingDate);?></td>
                                     ...
                                     <tr>
<td ><b>Matiere</b></td>
                                            <td colspan="5"><?php echo htmlentities($result->NomMatiere);?></td> 

</tr>
                                    <tr>
                                             <td ><b>Date de Reservation:</b></td>
                                            <td colspan="2"><?php echo htmlentities($result->FromDate);?></td>
                                            <td><b>Date de Retour</b></td>
                                            <td colspan="2"><?php echo htmlentities($result->ToDate);?></td>
