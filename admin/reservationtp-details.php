<?php
    ...
    $sql="UPDATE reservationtp set IsRead=:isread where id=:did";
    ...
    $sql="UPDATE reservationtp set Status=:status,AdminRemarkDate=:admremarkdate where id=:did";
    $query = $dbh->prepare($sql);
                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            $sql = "SELECT reservationtp.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,reservationtp.NomClub,reservationtp.PostingDate,reservationtp.Status,reservationtp.AdminRemarkDate,reservationtp.description from reservationtp join tblemployees on reservationtp.empid=tblemployees.id where reservationtp.id=:lid";
                                            $query = $dbh -> prepare($sql);
...
<td ><b>Club</b></td>
                                            <td colspan="5"><?php echo htmlentities($result->NomClub);?></td> 
