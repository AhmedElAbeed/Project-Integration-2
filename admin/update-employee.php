                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Modifier Enseignat</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">Enseignats </a></li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Chef du Department <i class="fa fa-angle-down"></i></h4>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Modifier les champs suivants svp</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ID Utilisateur</label>
