<?php
    ...
    if(isset($_POST['signin']))
    {
            ...
            if($status==0)
        {
            ...
            echo "<script type='text/javascript'> document.location = 'employees/rattrapage.php'; </script>";
        }
            }   else  {
                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">Accéder aux Panel D'admin</a></p>
                        </div>
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="Register.php">Register-ici</a></p>
                        </div>
                    </div>
                </form>
            </div>
