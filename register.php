...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            ...
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="assets/images/icon/iset.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="Register.php" aria-expanded="true"><i class="ti-user"></i><span>Register
                                    </span></a>
                            </li>

                            <li class="#">
                                <a href="index.php" aria-expanded="true"><i class="ti-user"></i><span>Login
                                    </span></a>
                            </li>
                            <li class="#">
                                <a href="password-recovery.php" aria-expanded="true"><i class="ti-key"></i><span>Mot Passe oublié
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <p>&nbsp;
                            ...
                            <h4 class="page-title pull-left">Panel Authentification</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="index.php">Index</a></li>
                                <li><span>Crée un Utilisateur</span></li>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-email-input" class="col-form-label">Adresse Email</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Région</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Gouvernement</label>
                                            <input class="form-control" name="city" type="text"   autocomplete="off" required>
                                        </div>

                                        <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return valid();">Valider</button>
                                        <button class="btn btn-primary" type="reset" onclick="return valid();">Reset</button>
